...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> Register([FromBody] Register dto)
    {
        ...
        try
        {
            var existingUserId = await UserRepository.GetUserIdAsync(dto.Username, _connectionString);
            ...
            await UserRepository.AddNewUserAsync(dto.Username, hashedPassword, _connectionString);
    ...
    public async Task<IActionResult> Login([FromBody] Login dto)
    {
        ...
        try
        {
            var userId = await UserRepository.GetUserIdAsync(dto.Username, _connectionString);
            if (!userId.HasValue)
            {
